...
client.on("ready", () => {
  ...
  console.log(`(C) 2018 - 2022 Eddie Miranda.`)
  console.log(`(C) 2014 - 2022 Maria Le.`)
  ...
  console.log(`This application is currently under development. If you would like to assist in the process: feel free to message us.`)
  console.log(`Our Social Handles:`)
  console.log(`Reddit: Moist_Programmer_514`)
  console.log(`Guilded: EddieMiranda1640`)
  console.log(`Discord: EddieMiranda2000#1959`)
